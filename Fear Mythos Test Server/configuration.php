...
if ($op == "") {
	...
	$setup = array(
		...
		"expirecontent"=>"Days to keep comments and news?  (0 = infinite with a Defualt of 180),int",
		"expiretrashacct"=>"Days to keep never logged-in accounts? (0 = infinite with a Defualt of 1),int",
		"expirenewacct"=>"Days to keep 1 level (0 dragon) accounts? (0 =infinite with a Defualt of 10),int",
		"expireoldacct"=>"Days to keep all other accounts? (0 = infinite with a Defualt of 45),int",
