<?php
$which=httpget('p');
output("You enter the Pyramid to defend it, walls are no barrier to you, you may move freely, to find, attack and kill your enemies.  One thing however, you must FIND them FIRST!");
output_notl("`n`n");
