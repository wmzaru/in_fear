...
function clanhitlist_run() {
	...
	switch ($op) {
        ...
        Case "add":
            addnav("Back to the list","runmodule.php?module=clanhitlist");
        ...
        case "edit":
			addnav("Back to the list","runmodule.php?module=clanhitlist");
			addnav("Add to the list","runmodule.php?module=clanhitlist&op=add");
			rawoutput("<table>");
...
function clanhitlist_navs() {
	if (httpget('module')=='clanhitlist') {
		...
		if (httpget('op')!='') addnav("M?Back to the hit list","runmodule.php?module=clanhitlist");
		villagenav();
	} elseif (httpget('module')=='') {
		addnav("Clan Options");
		addnav("H?To the hit list","runmodule.php?module=clanhitlist");
	}
}
