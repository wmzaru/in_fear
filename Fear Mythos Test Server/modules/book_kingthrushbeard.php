...
function book_kingthrushbeard_getmoduleinfo(){
	$info = array(
...
function book_kingthrushbeard_install(){
...
function book_kingthrushbeard_uninstall(){
	return true;
}

function book_kingthrushbeard_dohook($hookname, $args){
	global $session;
	...
	if ($card==1){
			...
			addnav("King Thrushbeard", "runmodule.php?module=book_kingthrushbeard");
		break;
	}
	}
	return $args;
