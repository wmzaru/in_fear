...
function uniqueforests_getmoduleinfo(){
	$info = array(
		...
		"prefs-city"=>array(
			...
			"desc"=>"What is the description?,textarearesizable|`c`pThe sea of lost dreams`c`n`n`xAs far as your eyes can see, you are sorrounded by a sea of sand and dust that awaits those ready and brave enough to explore it.  
