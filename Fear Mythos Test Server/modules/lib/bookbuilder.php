<?php
		if ($modulename == "" or $bookname == "" or $bookauthor == "" or $booktext == "" or $modulesubmit == ""){
			...
			rawoutput("Book Text: (formated HTML source)<br>&nbsp;<textarea cols='50' rows='20' name='booktext'>$booktext</textarea><br><br>");
			...
			rawoutput("<tr><td style='vertical-align: top;'><code>".$progcode."</code><br></td></tr></tbody></table>");
			output("?>");
