...
if ($modulesubmit == ""){
	...
	rawoutput("Quest Story Part 1: <br><textarea cols='60' rows='10' name='queststoryp1'>".$queststoryp1."</textarea><br>");
	rawoutput("Quest 1st step Message: <input value='".$queststep1mess."' size='60' name='queststep1mess'><br><br>");
	rawoutput("Quest Story Part 2:<br><textarea cols='60' rows='10' name='queststoryp2'>".$queststoryp2."</textarea><br>");
	...
	rawoutput("Quest Story Part 3:<br><textarea cols='60' rows='10' name='queststoryp3'>".$queststoryp3."</textarea><br>");
	rawoutput("Quest 3rd step Message: <input value='".$queststep3mess."' size='60' name='queststep3mess'><br><br>");
	rawoutput("Quest Story Part 4:<br><textarea cols='60' rows='10' name='queststoryp4'>".$queststoryp4."</textarea><br>");
	...
	rawoutput("Quest Story End: <br><textarea cols='60' rows='10' name='queststoryend'>".$queststoryend."</textarea><br>");
