...
function alignmentbuffs_getmoduleinfo(){
	$info = array(
		...
		"settings"=>array(
			"First Buff,title",
				"activate1"=>"Buff activates on alignment under,int|-90",
			...
			"Second Buff,title",
				"activate2"=>"Buff activates on alignment under x and over that of first buff,int|-75",
			...
			"Third Buff,title",
				"activate3"=>"Buff activates on alignment under x and over that of second buff,int|-30",
			...
			"Forth Buff,title",
				"activate4"=>"Buff activates on alignment over x and under that of forth buff,int|30",
			...
			"Fifth Buff,title",
				"activate5"=>"Buff activates on alignment over x and under that of fifth buff,int|75",
			...
			"Sixth Buff,title",
				"activate6"=>"Buff activates on alignment over,int|90",
