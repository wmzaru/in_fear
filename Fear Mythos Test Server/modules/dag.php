...
function dag_getmoduleinfo(){
	$info = array(
		...
		"author"=>"Darrel Morrone<br>Updates by Andrew Senger, JT Traub, and Eric Stevens<br />Clan addition by `%kickme",
		"version"=>"1.5.1",
		"vertxtloc"=>"http://dragonprime.net/users/kickme/",
		"category"=>"Inn",
		"download"=>"http://dragonprime.net/users/kickme/dag_with_clans.zip",
		"settings"=>array(
			...
			"update"=>"Update clans when listing bountys? (not recommend for servers with lots of bountys),bool|1"
		),
		"prefs"=>array(
