...
if ($modulename == "" or $modulesubmit == ""){
	...
	rawoutput("Village Header&nbsp;Text: <br><textarea class='input' cols='60' rows='20' name='villagemessage'>".$villagemessage."</textarea><br>");
	...
	if ($usevillage == 1) 
	$code .= "			\"villagename\"=>\"Name for the ".$moduletitle." village|".$villagename."\",\n";
	...
	if ($raceboon == "defense"){
	$code .= "					\"defmod\"=>\"(".("<defense>")."?(1+((".$buffseed."+floor(".("<level>")."/5))/".("<defense>").")):0)\",\n";
	}elseif ($raceboon == "attack"){
	$code .= "					\"atkmod\"=>\"(".("<attack>")."?(1+((".$buffseed."+floor(".("<level>")."/5))/".("<attack>").")):0)\",\n";
	}elseif ($raceboon == "regen"){
	//this will propably need tweaking
	$code .= "					\"regen\"=>\"(".("<defense>")."?(1+((".$buffseed."+floor(".("<level>")."/5))/".("<defense>").")):0)\",\n";
	}
