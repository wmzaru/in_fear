...
rawoutput("Event Introduction Story:<br><textarea class='input' cols='60' rows='20' name='eventintrostory'>".$eventintrostory."</textarea><br>");
rawoutput("The Big Question<br><textarea class='input' cols='60' rows='4' name='thebigquestion'>".$thebigquestion."</textarea><br>");
rawoutput("Yes Option <input name='yesoption' value='".$yesoption."'><br>");
rawoutput("No Option <input name='nooption' value='".$nooption."'><br><br>");
rawoutput("Player picks no to running event text:<br><textarea class='input' cols='60' rows='8' name='notext'>".$notext."</textarea><br>");
rawoutput("Run Event Text:<br><textarea class='input' cols='60' rows='12' name='yestext'>".$yestext."</textarea><br>");
...
rawoutput("</small>Good Outcome Message: <br><textarea class='input' cols='60' rows='6' name='goodeffectmessage'>".$goodeffectmessage."</textarea><br><br>");
...
rawoutput("Bad Outcome Message:<br><textarea class='input' cols='60' rows='6' name='badeffectmessage'>".$badeffectmessage."</textarea><br><br>");
