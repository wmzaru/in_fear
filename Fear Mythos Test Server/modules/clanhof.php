<?php
//1.2 moved clan kills and added clan points per player to clanhof instead of clanpyramid file
...
function clanhof_dohook($hookname,$args){
	...
	switch ($hookname){
		case "header-hof":
			require_once("modules/clanhof/dohook/header-hof.php");
			break;
		case "footer-hof":
			require_once("modules/clanhof/dohook/footer-hof.php");
			break;
		case "footer-clan":
