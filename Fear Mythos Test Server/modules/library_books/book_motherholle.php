...
function book_motherholle_getmoduleinfo(){
	$info = array(
		"name"=>"Mother Holle",
...
function book_motherholle_install(){
...
function book_motherholle_uninstall(){
	return true;
}

function book_motherholle_dohook($hookname, $args){
	global $session;
	...
	if ($card==1){
			...
			addnav("Mother Holle", "runmodule.php?module=book_motherholle");
		break;
	}
	}
	return $args;
