...
function book_oldsultan_getmoduleinfo(){
	$info = array(
		"name"=>"Old Sultan",
...
function book_oldsultan_install(){
...
function book_oldsultan_uninstall(){
	return true;
}

function book_oldsultan_dohook($hookname, $args){
	global $session;
	...
	if ($card==1){
			...
			addnav("Old Sultan", "runmodule.php?module=book_oldsultan");
		break;
	}
	}
	return $args;
