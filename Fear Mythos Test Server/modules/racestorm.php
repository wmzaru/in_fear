...
function racestorm_getmoduleinfo(){
	$info = array(
		...
		"settings"=>array(
			...
			"mindk"=>"How many DKs do you need before the race is available?,int|70",
			"maxdk"=>"Maximum dks for which this race is available?,int|90",
...
function racestorm_dohook($hookname,$args){
	...
	case "pointsdesc":
		...
		$str = translate("The race: Storm Giant; The Masters of the Hillfolk.  This costs %s points and lasts for %s dragon kills");
