...
function book_fitchersbird_getmoduleinfo(){
	$info = array(
		"name"=>"Fitcher's Bird",
...
function book_fitchersbird_install(){
...
function book_fitchersbird_uninstall(){
	return true;
}

function book_fitchersbird_dohook($hookname, $args){
	global $session;
	...
	if ($card==1){
			...
			addnav("Fitcher's Bird", "runmodule.php?module=book_fitchersbird");
		break;
	}
	}
	return $args;
