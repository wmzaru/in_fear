...
function geishawagon_getmoduleinfo(){
	$info = array(
		"name"=>"Scarlet Marked, a Geisha Wagon edit.",
		"version"=>"1.0",
		"author"=>"`6Harry B and Kenny Chu with edits by WereMagi",
...
function geishawagon_runevent($type)
{
	...
	$op = httpget('op');
	if ($op=="" || $op=="search"){
		output("`n`2 You encounter a traveling wagon full of what appears to be rather ragged looking tavern wenchs. They stop and stare. ");
		output("`n`2 They begin speaking amongst themselves as they stare at you, making you stop and wait. ");
		output("`n`n\"`^For a gem, we can give you our service`6\", calls out one girl, rather shamefully.");
		...
		output("`n`n`2 You dig out of your gems and hand it to the girl.");
