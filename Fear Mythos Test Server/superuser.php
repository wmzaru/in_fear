...
output("`^You open a Door in the City to the Penthouse. ");
if ($session['user']['sex']){
  	output("Inside you are greeted by the sight of numerous muscular bare-chested men who smile as they wave palm fronds at you and offer to feed you grapes as you lounge on Greco-Roman couches draped with silk.`n`n");
}else{
	output("Inside you are greeted by the sight of numerous scantily clad buxom women who wink and wave palm fronds at you and offer to feed you grapes as you lounge on Greco-Roman couches draped with silk.`n`n");
}
